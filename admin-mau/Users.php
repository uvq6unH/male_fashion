...
$sql = "SELECT ID, NAME, USERNAME, EMAIL, PHONE, ADDRESS, ROLE, CREATED_DATE, ISACTIVE FROM user";
                                    ...
                                    <tbody>
                                        ...
                                        if ($result->num_rows > 0) {
                                            while ($row = $result->fetch_assoc()) {
                                                ...
                                                echo "<td><a href='update-user.php?id={$row['ID']}' class='btn btn-outline-warning btn-sm'>Update</a></td>";
                                                echo "<td><a href='delete-user.php?id={$row['ID']}' class='btn btn-outline-danger btn-sm'>Delete</a></td>";
                                                echo "</tr>";
                                            }
                                        } else {
